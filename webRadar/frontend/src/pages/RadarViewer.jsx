        ...
        if (event.data instanceof ArrayBuffer) {
          ...
          if (msgType === 1) {
            ...
            for (let i = 0; i < playerCount; i++) {
              ...
              const is_local = view.getInt32(offset, true) === 1; offset += 4;
              ...
              parsedPlayers.push({ x, y, z, rotation: angle, health, team, is_local, name: pName });
            }

            setPlayers(parsedPlayers);
            setMapName(parsedMapName || 'Unknown');
          }
          return;
        }
