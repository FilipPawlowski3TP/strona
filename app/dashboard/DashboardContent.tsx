...
export default function DashboardContent({ user, daysLeft }: DashboardContentProps) {
            ...
            <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-zinc-900/40 border border-white/5 p-8 rounded-3xl backdrop-blur-sm">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center space-x-2 px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-sm font-bold rounded-xl transition-all border border-zinc-700/50 shadow-lg"
                    >
                    ...
                    <div className="bg-zinc-900/40 border border-white/5 p-8 rounded-3xl space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center py-4">
                                ...
                                {daysLeft > 0 ? (
                                    <span className="text-indigo-400 font-black">{daysLeft} DAYS</span>
                                ) : (
                        ...
                        <button className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl transition-all shadow-xl shadow-indigo-500/20 active:scale-[0.98]">
                            Extend Access
                        </button>
                    </div>
